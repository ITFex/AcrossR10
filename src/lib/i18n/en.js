...
const en = {
  ...
  leaderboard: {
    ...
    pageIntro: 'All registered participants who have successfully crossed the Rennsteig 10 times – grouped by gender and age class.',
    filters: { all: 'All', M: 'Male', W: 'Female', D: 'Non-binary' },
    ageClasses: {
      u30:  'AK U30 (under 30)',
      ak30: 'AK 30 (30–39)',
      ak40: 'AK 40 (40–49)',
      ak50: 'AK 50 (50–59)',
      ak60: 'AK 60+ (60 and over)',
    },
    colRank:      'Rank',
    colName:      'Name',
    colGender:    'Gender',
    colCrossings: 'Crossings',
    colDate:      'Date',
    empty:        'No entries in this category yet.',
    hint:         'Only participants who have opted in to public listing appear here.',
  },
  members: {
    ...
    profile: {
      heading: 'Leaderboard & Profile',
      intro: 'Set up your profile to appear on the leaderboard once you have completed all 10 crossings.',
      genderLabel: 'Gender',
      genderOptions: { M: 'Male', W: 'Female', D: 'Non-binary' },
      birthYearLabel: 'Year of birth',
      publicLabel: 'Show me on the leaderboard',
      save: 'Save profile',
      saving: 'Saving …',
      edit: 'Edit profile',
      cancel: 'Cancel',
      ...
      completedBanner: 'Congratulations – you have completed all 10 crossings!',
      leaderboardLink: 'Go to leaderboard',
    },
    catering: {
